...
Protocol version **2.1**, package revision **1**.
...
1. Obtain the public `v2.1` release and verify its full commit, or use an approved bundle with a trusted manifest hash. Do not silently substitute `main/latest`.
...
| [Migration](templates/MIGRATE_TO_2.1.md) | Explicit cutover preserving existing work |
