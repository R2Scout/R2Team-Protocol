...
Use configured GitHub or Azure DevOps Server/TFS semantics. For CMMI check Requirement→Task/Bug parent-child and leaf→PR development links against actual server mapping, not a GitHub-only model. Don't claim unavailable API checks passed.
